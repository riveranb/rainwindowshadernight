    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed fog_trail = smoothstep(-0.05, 0.05, drop_pos.y);
                ...
                fog_trail *= smoothstep(0.05, 0.033, abs(drop_pos.x)) * 0.5;
                ...
                col = tex2D(_MainTex, i.uv + offset * _Distort);
